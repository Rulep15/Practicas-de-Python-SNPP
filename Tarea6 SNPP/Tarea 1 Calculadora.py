...
btnSuma = Button(vtn,text="+",bg='gray',fg='black',width=11,command=suma)
btnSuma.grid(row=3,column=1)
btnResta = Button(vtn,text="-",bg='gray',fg='black',width=11,command=Resta)
btnResta.grid(row=3,column=2)
btnMulti = Button(vtn,text="x",bg='gray',fg='black',width=11,command=Multi)
btnMulti.grid(row=4,column=1)
btnDivi = Button(vtn,text="/",bg='gray',fg='black',width=11,command=Divi)
